...
@InputType()
class PromotionCreateNestedManyWithoutProductsInput {
...
export { PromotionCreateNestedManyWithoutProductsInput as PromotionCreateNestedManyWithoutProductsInput };
